defmodule WxConstants do
  ...
  # From "defs.h"
  def wxVSCROLL, do: 0x80000000
  def wxHSCROLL, do: 0x40000000
  def wxCAPTION, do: 0x20000000
  def wxDOUBLE_BORDER, do: 0x10000000
  def wxSUNKEN_BORDER, do: 0x08000000
  def wxRAISED_BORDER, do: 0x04000000
  def wxBORDER, do: wxSIMPLE_BORDER
  def wxSIMPLE_BORDER, do: 0x02000000
  def wxSTATIC_BORDER, do: 0x01000000
  def wxNO_BORDER, do: 0x00200000
  def wxALWAYS_SHOW_SB, do: 0x00800000
  def wxCLIP_CHILDREN, do: 0x00400000
  def wxCLIP_SIBLINGS, do: 0x20000000
  def wxTRANSPARENT_WINDOW, do: 0x00100000
  def wxTAB_TRAVERSAL, do: 0x00080000
  def wxWANTS_CHARS, do: 0x00040000
  def wxMOTIF_RETAINED, do: 0x00020000
  def wxRETAINED, do: 0x00000000
  def wxBACKINGSTORE, do: wxRETAINED

  def wxPOPUP_WINDOW, do: 0x00020000
  def wxFULL_REPAINT_ON_RESIZE, do: 0x00010000
